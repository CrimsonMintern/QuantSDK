...
class Client:
    # todo codes for order directions
    # todo codes for order types
    ...
    def make_api_call(self, route: str, method: str, params=None, data=None):
    ...
    def get_order_book(self, exchanges: Union[str, List[str]], base: str, quote: str, depth: int = 1):
        ...
        # clean exchange list
        exchanges = extract_exchanges(exchanges=exchanges)
    ...
    def place_order(self,
        ...
        if order_type == self.MARKET_ORDER:
            ...
            if price is None:
                raise ValueError("Need to specify price for Limit Order")
            data = {
                'BaseCurrency': base.upper(),
                'QuoteCurrency': quote.upper(),
                'Quantity': quantity,
    ...
    def cancel_order(self, order_id: str):
        url_extension = f'/trading/orders/{order_id}/cancel'
